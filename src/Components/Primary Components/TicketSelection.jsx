...
function TicketSelection() {
  return (
    <div className="w-[90%] p-[24px] border-[#197686] border-[1px] ms:w-[70%] md:p-[48px] rounded-2xl space-y-6">
        <section className="flex-col justify-center items-center space-y-3">
            ...
            <div className="bg-[#0E464F] h-[4px] w-full;"></div>
        </section>
        <article>
            <div className="banner min-h-[243px] m p-[10px] md:p-[24px] text-white text-center text-[14px] flex-col justify-center item-center space-y-4">
